			...
			<?php for($i=0;$i<$topicCount;$i++) { //topic list ------------ ?>
				<div class="row panel">
					...
					<div class="col-sm-6 col-xs-6">
						<?php //Topic Name Stuff
							echo "<a href=\"topic.php?tid=".$topicList[$i]['TopicID']."\">".$topicList[$i]['Title']."</a>"; 
							if ($topicList[$i]['good_level']!=0) echo "<span class=\"label label-danger\">精</span>";
						?>
						<br/><?php echo $topicList[$i]['preview_content'];?>...
					</div>
					<div class="col-sm-4 col-xs-4">
						<i class="fa fa-pencil-square-o"></i>
						<?php echo $topicList[$i]['Name']; ?>
						<br/>
